      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <div class="relative mr-6">
          <div class="t-0 absolute left-3">
            <p class="flex h-2 w-2 items-center justify-center rounded-full bg-primary p-3 text-xs text-white">0</p>
          </div>
          <a href="#" class="hover:text-primary transition">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16" stroke="currentColor"
        ...
        <div class="mr-6">
          <p class="text-gray-500 font-medium text-sm">HOTLINE:</p>
          <p class="text-black font-bold text-sm">0019008188</p>
        </div>
